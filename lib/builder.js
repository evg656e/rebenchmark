...
export function run(opts) {
    if (root === null)
        return Promise.reject(new Error('Missing benchmarks'));
...
export function resetOptions(opts) {
    globalOpts = {
        ...opts,
        grep: coerceGrep(opts.grep, true),
        reporter: coerceReporter(opts.reporter, opts.reporterOptions)
    };
